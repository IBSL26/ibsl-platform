...
'.chapter-head .revised{display:inline-block;margin-left:10px;font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#b06a00;background:#fbe9c8;border-radius:3px;padding:2px 8px;vertical-align:middle;}',
...
'      sub.textContent = dt ? ("Submitted "+dt) : "";',
'      if(subs.length>1){ var rb=el("span","revised","Revised \\u00d7"+subs.length); sub.appendChild(document.createTextNode(" ")); sub.appendChild(rb); }',
